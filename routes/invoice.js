...
const { porcentajeIva, importaExistencias, listUltimaFactura, saveFactura, updateFactura, deleteFactura, lastNumFactura, firmaFactura } = require('../controllers/invoice');
...
router.post( '/actions/facturapornumero/:id', firmaFactura );
